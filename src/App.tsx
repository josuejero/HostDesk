    ...
    <div className="app-shell">
      <header className="hero">
        <div>
          ...
          <h1>
            HostDesk
            <span>Hosting-support triage simulator modeling SLAs, KB, and empathy.</span>
          </h1>
          <p className="hero-blurb">
            Promote yourself as the kind of agent who can ride an SLA timer, escalate intelligently, share a KB article, and
            close the loop with a confident postmortem.
          </p>
          <p className="resume-snippet">
            Resume-ready framing: Built HostDesk, a hosting-support operations simulator in React/TypeScript that models SLA-based
            triage, tiered routing, KB article suggestions, private notes, and empathy-focused scoring; deployed free on GitHub Pages.
          </p>
          <div className="cta-group">
            <button className="primary" onClick={() => handleSelectTicket('ticket-billing-suspension')}>
              Billing Suspension
            </button>
            <button className="primary" onClick={() => handleSelectTicket('ticket-minecraft-plugin')}>
              Minecraft Plugin Crash
            </button>
            <button className="primary" onClick={() => handleSelectTicket('ticket-discord-bot')}>
              Discord Bot Overnight Outage
            </button>
          </div>
          <div className="quick-actions">
            <button onClick={handleToggleScenarioLibrary}>View all scenarios</button>
            <button onClick={handleReset}>Reset demo data</button>
            <button onClick={handleToggleWalkthrough}>Open recruiter walkthrough mode</button>
          </div>
        </div>
      </header>
